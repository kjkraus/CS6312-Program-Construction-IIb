...
public class Room {
    ...
    public String getLocation() {
        return "Room at [" + this.idOfRoom + "]";
    }
    
    /**
     * Accessor method that returns the treasure that is currently in the room
     * 
     * @return	an TreasureChest object of the treasure in the room
     */
    public TreasureChest getTreasure() {
        return this.roomTreasureChest;
    }
    ...
    public String toString() {
        return "and is located in Room at position " + this.idOfRoom;
    }
}
