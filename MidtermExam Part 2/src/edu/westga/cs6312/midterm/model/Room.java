...
public class Room {
    ...
    private void setUpRoom() {
        ...
        if (chance >= 50 && chance <= 74) {
            this.roomTreasureChest = this.createTreasure();
        } else if (chance >= 75) {
            this.roomTreasureChest = this.createRandomTreasure();
        }
    }
    ...
    /**
     * Helper method to create and return a random treasure
     */
    private RandomTreasure createRandomTreasure() {
        RandomTreasure roomRandomTreasure = new RandomTreasure(this.random);
        return roomRandomTreasure;
    }
